...
const CONSULTAS_DATA = [
  ...
  {
    title: "Proctologia",
    subtitle: "Intestino e Reto",
    description: "Prevenção, diagnóstico e tratamento das doenças do intestino grosso, reto e ânus.",
    tags: ["Hemorroidas", "Colonoscopia", "Prevenção"],
    price: "R$189",
    icon: Activity
  },
  {
    title: "Obstetrícia",
    subtitle: "Saúde Materna",
    description: "Acompanhamento da mulher durante a gravidez, parto e pós-parto.",
    tags: ["Pré-natal", "Parto", "Maternidade"],
    price: "R$229",
    icon: Baby
  }
];
