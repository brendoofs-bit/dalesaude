        ...
        <div className="container mx-auto px-4 md:px-8 max-w-6xl space-y-24">
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="w-full md:w-1/2 rounded-3xl overflow-hidden shadow-lg">
              <img src="https://res.cloudinary.com/xkdz1q1u/image/upload/v1787016173/medica-sorridente-com-estetoscopio-em-clinica.webp" alt="Nossa missão" className="w-full h-full object-cover aspect-[4/3]" />
            </div>
          ...
          <div className="flex flex-col md:flex-row-reverse items-center gap-12">
            <div className="w-full md:w-1/2 rounded-3xl overflow-hidden shadow-lg">
              <img src="https://res.cloudinary.com/xkdz1q1u/image/upload/v1787016479/medico-avaliando-mao-de-paciente-em-consultorio.webp" alt="Nossa visão" className="w-full h-full object-cover aspect-[4/3]" />
            </div>
            <div className="w-full md:w-1/2">
